...
public class WaterHeater extends WinkDevice {
    ...
    private String water_heater_id;
    ...
    public String getWater_heater_id() {
        return water_heater_id;
    }

    public void setWater_heater_id(String water_heater_id) {
        this.water_heater_id = water_heater_id;
    }
